...
cannon_data = Table.read(galah_data_input+'sobject_iraf_iDR2_180108_cannon.fits')
...
galah_gaia_match['Feh_diff'] = galah_gaia_match['Feh_cannon'] - galah_gaia_match['Feh_bench']
...
print galah_gaia_match['sobject_id', 'std_name', 'Feh_bench', 'e_Feh_bench', 'Feh_cannon', 'e_Feh_cannon', 'flag_cannon']
