...
spectra_file_list = ['galah_dr52_ccd1_4710_4910_wvlstep_0.020_lin_renorm_'+data_date+'.pkl',
                     'galah_dr52_ccd2_5640_5880_wvlstep_0.025_lin_renorm_'+data_date+'.pkl',
                     'galah_dr52_ccd3_6475_6745_wvlstep_0.030_lin_renorm_'+data_date+'.pkl',
                     'galah_dr52_ccd4_7700_7895_wvlstep_0.035_lin_renorm_'+data_date+'.pkl']
...
for i_b in [2]:#range(len(spectra_file_list)):
    print 'Band:', i_b+1
    ...
    for i_r in range(len(to_read_row)):
        plt.plot(wvl_values, solar_spectra[i_r, :], lw=1, c='black', alpha=0.02)
    plt.show()
    # plt.savefig('b'+str(i_b+1)+'_solar_galah_renorm.png', dpi=750)
    plt.close()
